...
# List of wallets
wallets = [
    {'private_key': 'private_key_1', 'address': 'address_1'},
    {'private_key': 'private_key_2', 'address': 'address_2'},
...
def print_wallet_balance(web3, address):
    ...
    print(f"Wallet {address} Balance: {balance_in_eth:.5f} ETH")
...
def main():
    ...
    transaction_count = 10  # Set the number of transactions per wallet

    for wallet in wallets:
        executed_transactions = 0  # Counter for successful transactions
        print(f"\nStarting transactions for wallet: {wallet['address']}\n")
        ...
        # Print total executed transactions for the wallet
        print(f"\nTotal executed transactions for wallet {wallet['address']}: {executed_transactions}/{transaction_count}")
